...
template <typename Key,
          ...
          typename StorageRef,
          typename... Operators>
__host__ __device__ constexpr void static_map_ref<
  Key,
  T,
  Scope,
  KeyEqual,
  ProbingScheme,
  StorageRef,
  Operators...>::InitMapRef(cuco::empty_key<Key> empty_key_sentinel,
                                cuco::empty_value<T> empty_value_sentinel,
                                KeyEqual const& predicate,
                                ProbingScheme const& probing_scheme,
                                cuda_thread_scope<Scope>,
                                StorageRef storage_ref) noexcept
{
  impl_ = impl_type{cuco::pair{empty_key_sentinel, empty_value_sentinel}, predicate, probing_scheme, storage_ref};
}
