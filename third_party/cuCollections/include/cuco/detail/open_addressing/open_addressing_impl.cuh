...
template <class Key,
          ...
          class KeyEqual = thrust::equal_to<int32_t>,
          class ProbingScheme = cuco::linear_probing<1, cuco::default_hash_function<int32_t>>,
          class Allocator = cuco::cuda_allocator<cuco::pair<int32_t, int32_t>>,
